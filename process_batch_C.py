...
def convert_k_to_f(temp_k):
    ...
    Use built in float() function to convert the string to a float (a floating point number)
...
def process_rows(input_file_name, output_file_name):
    ...
    with open(input_file_name, "r") as input_file:
        ...
        with open(output_file_name, "w", newline="") as output_file:
            ...
            for row in reader:
                # Extraxt the values from the input row into named variables
